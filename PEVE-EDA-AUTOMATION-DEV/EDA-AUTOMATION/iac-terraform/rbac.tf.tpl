resource "confluent_role_binding" "rbac_${PRINCIPAL}_${RESOURCE_TYPE}_${RESOURCE_NAME0}_${PATTERN_TYPE}_${OPERATION}" {
  ...
  crn_pattern = "crn://confluent.cloud/organization=${var.organization_id}/environment=${var.environment_id}/${RESOURCE_CRN}/${RESOURCE_TYPE}=${RESOURCE_NAME}${PATTERN_VALUE}"
