#!/bin/bash
set -euo pipefail
#source ./devops/scripts/validate_yaml/validate_topics.sh
...
validar_topicos(){
  ...
  for file in $files; do
    ...
    if [ -f $topics_yaml ]; then
      ...
      ./devops/scripts/validate_yaml/validate_topics.sh $topics_yaml
    else 
...
validar_estructura_subjects(){
  ...
  for file in $files; do
    ...
    if [ -f $subjects_yaml ]; then
      ...
      ./devops/scripts/validate_yaml/validate_subjects.sh $subjects_yaml
    else 
...
validar_estructura_rbac(){
  ...
  for file in $files; do
    ...
    if [ -f $rbac_yaml ]; then
      ...
      ./devops/scripts/validate_yaml/validate_rbac.sh $rbac_yaml
    else 
